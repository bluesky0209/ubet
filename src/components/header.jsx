...
const Header = () => {
    ...
    return (
        <>
            <header className="bg-[#171c2c] border-b border-black w-full md:block hidden">
                                ...
                                <div className="absolute z-[99] bg-[#3b414a] text-white top-[30px] text-[14px] right-0 min-w-[130px]">
                                    {languages.map((language) => (
                                        <div
                                            ...
                                            className={`w-[180px] text-white text-left border-b border-[#171c2c] p-[5px_10px] whitespace-nowrap cursor-pointer hover:bg-[#293043] bg-[${language.code === 'ar' ? '#ab0404' : '#293043'}]`}
                                        >
                                            {language.name}
                                        </div>
                                    ))}
            ...
            <header className="bg-[#171c2c] h-[70px] border-b border-black w-full md:hidden block">
                <div className="flex justify-between items-center h-16 max-w-[1720px] mx-auto">
                    <div className="flex h-[60px] p-[5px] w-full">
                        <div className="w-full h-[50px] ml-0 bg-[url('/logo.png')] bg-[0px_center] bg-[length:auto_35px] bg-no-repeat" />
                    </div>

                    <div className="flex flex-col justify-end items-center h-full ml-auto">
                        <div className="flex flex-row justify-end items-center h-full w-full">
                            <div className="flex items-center justify-end text-[#bbb] hover:text-white h-[30px] p-[0px_7px] cursor-pointer">
                                <ChatIcon />
                            </div>
                        ...
                        <div className="flex items-center mr-[5px] text-[14px] w-full">
                            <span className="text-[12px] !leading-[1.8] h-[30px] whitespace-nowrap rounded-[5px_0_0_5px] bg-[#ffffff00] text-[#bbb] border border-solid border-[#52668c] font-medium p-1 cursor-pointer">Sign In</span>
                            <span className="text-[12px] !leading-[1.8] h-[30px] whitespace-nowrap rounded-[0_5px_5px_0] bg-[#1a7051] text-[#bbb] border border-[#52668c] font-medium p-1 cursor-pointer">Register</span>
                        </div>
                    </div>
